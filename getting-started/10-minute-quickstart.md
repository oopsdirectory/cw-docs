...
{% embed url="https://youtu.be/2GS4QwtkV1U" caption="Getting Started on Oops Directory" %}

## Quick-start Steps

1. Visit [https://admin.oops.menu/register](https://admin.oops.menu/register) and sign up for an account
